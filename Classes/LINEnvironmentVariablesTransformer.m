//
//  LINEnvironmentVariablesTransformer.m
//  Lingon
//
/*
...
@implementation LINEnvironmentVariablesTransformer
...
-(id)transformedValue:(id)value
{
	...
	while (item = [enumerator nextObject]) {
		...
		[returnString appendFormat:@"%@=%@", [item valueForKey:@"key"], [item valueForKey:@"value"]];
	}
