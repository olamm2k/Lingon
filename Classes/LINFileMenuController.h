...
@interface LINFileMenuController : NSObject
{
	...
	IBOutlet NSButton *createImport;
	
	IBOutlet NSWindow *changeFilenameSheet;
	IBOutlet NSTextField *changeFilenameFolderTextField;
	IBOutlet NSTextField *changeFilenameNewNameTextField;
	IBOutlet NSTextField *changeFilenameOldNameTextField;
